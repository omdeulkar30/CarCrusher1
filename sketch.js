...
function preload() {
  ...
  CarCrash = loadImage("GroundMap/carCrash-removebg-preview.png")
  BoatCrash = loadImage("WaterMap/boatCrash-removebg-preview.png")
  PlaneCrash = loadImage("SkyMap/airplaneCrash-removebg-preview.png")
    ...
    if(mousePressedOver(Ferrari)){
     ...
     if(PlayerCar!=0){
       ...
       if(PlayerCar==1){
         ...
         AICar1=createSprite(100, height/2)
         AICar1.addImage("Buggati",BugattiImage)
         AICar2=createSprite(250, height/2)
         AICar2.addImage("Ferrari",FerrariImage)
         AICar3=createSprite(350, height/2)
         AICar3.addImage("Car",CarImage)
         AICar4=createSprite(500, height/2)
